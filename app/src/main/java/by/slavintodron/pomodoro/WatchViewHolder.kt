...
class WatchViewHolder (
        private val binding: ItemWatchBinding,
    ...
    private fun initButtonsListeners(stopwatch: ItemWatch) {
    ...
    private fun startTimer(stopwatch: ItemWatch) {
    ...
    private fun stopTimer(stopwatch: ItemWatch) {
    ...
    private fun getCountDownTimer(stopwatch: ItemWatch): CountDownTimer {
